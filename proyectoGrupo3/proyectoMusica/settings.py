"""
Django settings for proyectoMusica project.
...
SECRET_KEY = 'django-insecure-c3k_y1=o64wt^s^d^4vx!fgl6q4luj^g417)s14d7ur7e&lb5f'
...
ROOT_URLCONF = 'proyectoMusica.urls'
...
WSGI_APPLICATION = 'proyectoMusica.wsgi.application'
